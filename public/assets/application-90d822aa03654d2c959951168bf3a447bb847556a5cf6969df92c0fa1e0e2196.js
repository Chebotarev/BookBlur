...
(function() { this.JST || (this.JST = {}); this.JST["books/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="books-index">\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["books/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h4>',  book.escape('title') ,'</h4>\n<div class="container book-container">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["books/listed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<b> ',  book.get('title') ,'</b> <i>by ',  book.get('author') ,'</i>\n<button class="btn-xs btn-danger remove-book" data-id="',  book.id ,'">&times;</button>\n');}return __p.join('');};
}).call(this);
