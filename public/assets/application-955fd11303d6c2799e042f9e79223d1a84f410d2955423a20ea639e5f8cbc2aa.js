...
MyAssets = {
  'logo': '<img height="50" alt="bookblur-logo" src="/assets/logo-66b8f170422ab3cfe2f8616c02647f7a617b068ba5fca9bb6f52de2a80a03568.png" />'
}
;
/*!
...
(function() { this.JST || (this.JST = {}); this.JST["books/listed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<b> ',  book.get('title') ,'</b> <i class="small">by ',  book.get('author') ,'</i>\n<button class="btn-xs btn-danger remove-book glyphicon glyphicon-remove" data-id="',  book.id ,'"></button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["books/search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="search-field">Search for Book: </label>\n<input id="search-field" class="form-control" type="text" name="search">\n\n<div class="list-group search-results"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["books/search_result"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="add-book">\n  <!-- <input type="submit" class="btn-xs btn-success glyphicon glyphicon-plus" value=""> -->\n  <button type="submit" class="btn-xs btn-success add-book-btn"><span class="glyphicon glyphicon-plus" aria-hidden="true"> </span></button>\n  <b>',  book.title ,'</b> <i class="small">by ',  book.author ,'</i>\n\n  <input type="hidden" name="book[id]" value="',  book.id ,'">\n  <input type="hidden" name="book[title]" value="',  book.title ,'">\n  <input type="hidden" name="book[author]" value="',  book.author ,'">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["books/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="book-container" class="container"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h4 class="center">Reading Lists</h4>\n\n<ul id="list-index-items" class="list-group"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel-heading">\n  <p class="list-title">',  list.escape('title') ,'</p>\n  <button class="btn-xs btn-info expand-list glyphicon glyphicon-menu-right"></button>\n</div>\n\n');  if (list.escape('description') !== "") { ; __p.push('\n  <div class="panel-body">\n    <p class="list-desc">',  list.escape('description') ,'</p>\n  ');  } ; __p.push('\n</div>\n\n<ul class="list-group books-list"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <article class="col-xs-6">\n    <h3>Create a New List</h3>\n    \n    <form id="new-list-form">\n      <div class="form-group">\n        <label for="new-list-title">Title</label><br>\n        <input id="new-list-title" class="form-control" type="text" name="list[title]">\n      </div>\n\n      <div class="form-group">\n        <label for="new-list-description">Description</label><br>\n        <textarea\n          id="new-list-description"\n          class="form-control"\n          name="list[description]"\n          rows="5"\n        ></textarea>\n      </div>\n\n      <div class="form-group">\n        <label for="new-list-books">Books:</label>\n        <div id="new-list-books-container" class="form-control">\n          <ul id="new-list-books" class="list-group"></ul>\n        </div>\n      </div>\n\n      <input class="btn btn-primary" type="submit" value="Create List">\n    </form>\n  </article>\n\n  <aside id="new-form-search" class="col-xs-6"></aside>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["navbar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<div class="container-fluid">\n  <div class="navbar-header">\n    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse">\n      <span class="sr-only">Toggle navigation</span>\n      <span class="icon-bar"></span>\n      <span class="icon-bar"></span>\n      <span class="icon-bar"></span>\n    </button>\n    <a class="navbar-brand" href="#">BookBlur</a>\n  </div>\n\n  <div class="collapse navbar-collapse" id="navbar-collapse">\n    <ul class="nav navbar-nav">\n      <li><a href="#list/new">Create List</a></li>\n      <li><a href="#">News</a></li>\n    </ul>\n    <ul class="nav navbar-nav navbar-right">\n      <li>\n        <div class="navbar-form navbar-search">\n          <div class="form-group">\n            <input type="text" class="form-control" placeholder="Search">\n          </div>\n          <button type="submit" class="btn btn-default glyphicon glyphicon-search inactive"></button>\n        </div>\n      </li>\n\n      <li class="dropdown">\n        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">',  CURRENT_USERNAME ,' <span class="caret"></span></a>\n        <ul class="dropdown-menu" role="menu">\n          <li><a id="logout" href="#">Logout</a></li>\n        </ul>\n      </li>\n    </ul>\n  </div><!-- /.navbar-collapse -->\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["news"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>News Feed</h2>\n<h4>To Be Implemented</h4>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="lists-index"></div>\n');}return __p.join('');};
}).call(this);
